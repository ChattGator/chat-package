            ...
            <Dialog.Panel className="mx-auto p-5 w-1/2 rounded-lg bg-blue-50 shadow-lg">
                ...
                <div className="flex">
                    <div className="w-1/4 mt-4">
                        ...
                        <ListBox selected={selectedChat} setSelected={setSelectedChat} chatOptions={chatOptions}/>
                    </div>
                    {
                        selectedChat.name=='Create New Group' &&
                        <input className="ml-2 mt-8 grow shadow-md rounded-lg px-2" placeholder="Enter Group Name" required />
                    }
                    {
                        ...
                        <>
                            ...
                            <div className="grow mt-4">
                                ...
                                <ComboBox selected={selectedPeople} setSelected={setSelectedPeople} peopleOptions={peopleOptions} className="grow"/>
                            </div>
                        </>
                    }
                </div>
                {
                    ...
                    <div className="grow mt-4">
                        ...
                        <GroupComboBox selected={selectedGroup} setSelected={setSelectedGroup} peopleOptions={peopleOptions} className="grow"/>
                    </div>
                }
